<%@ Page Title="User Logins by Subscription" Language="C#" AutoEventWireup="true" CodeBehind="UserLoginsBySubscription.aspx.cs"
    Inherits="D_ReportUI.UserLoginsBySubscription" MasterPageFile="~/ReportNav.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <h1 style="color: #597790; margin-top: 0px; padding-top: 0px;">User Logins by Subscription</h1>
    <table>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="NoteLabel" runat="server" style="color:#597790"
                    Text="*Note: This report does not include Exams logins/subscriptions.*" ></asp:Label>
            </td>
        </tr>
    </table>
    <telerik:RadGrid ID="ReportRadGrid" runat="server" GridLines="None" OnNeedDataSource="ReportRadGrid_NeedDataSource">
        ...
        <MasterTableView GroupLoadMode="client" ShowGroupFooter="true" 
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="SubscriptionName" HeaderText="Subscription Name" 
                    ReadOnly="True" SortExpression="SubscriptionName" UniqueName="SubscriptionName"
                    Aggregate="CountDistinct" FooterText="Number of unique subscriptions: " AutoPostBackOnFilter="false" 
                    CurrentFilterFunction="Contains" FilterDelay="200">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Total" DataType="System.Int32" 
                    HeaderText="User Logins" ReadOnly="True" SortExpression="Total" UniqueName="Total"
                    Aggregate="Sum" FooterText="Total User Logins: ">
