<%@ Page Title="User Logins" Language="C#" AutoEventWireup="true" CodeBehind="UserLogins.aspx.cs"
    Inherits="D_ReportUI.UserLogins" MasterPageFile="~/ReportNav.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <h1 style="color: #597790; margin-top: 0px; padding-top: 0px;">User Logins</h1>
    <table>
        <tr>
            <td>
    ...
    <telerik:RadGrid ID="ReportRadGrid" runat="server" GridLines="None" OnNeedDataSource="ReportRadGrid_NeedDataSource">
        ...
        <MasterTableView GroupLoadMode="client" ShowGroupFooter="true" 
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="ReferringSite" HeaderText="Referring Site" 
                    ReadOnly="True" SortExpression="ReferringSite" UniqueName="ReferringSite"
                    AutoPostBackOnFilter="false" CurrentFilterFunction="Contains" FilterDelay="200">
                </telerik:GridBoundColumn>
