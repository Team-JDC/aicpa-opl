<%@ Page Title="Maximum Concurrent Users" Language="C#" AutoEventWireup="true" CodeBehind="MaxConcurrentUsers.aspx.cs"
    Inherits="D_ReportUI.MaxConcurrentUsers" MasterPageFile="~/ReportNav.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <h1 style="color: #597790; margin-top: 0px; padding-top: 0px;">Maximum Concurrent Users</h1>
    <table>
        <tr>
            <td>
        ...
        <MasterTableView GroupLoadMode="client" ShowGroupFooter="true" 
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="MaxConcurrentUsers" DataType="System.Int32" 
                    ...
                    Aggregate="Max" FooterText="Maximum Concurrent Users: ">
