...
<script type="text/javascript">
    $.timeout(600 * 60 * 1000, timeoutHandler); // set default timeout to 10 hours
</script>
<script type="text/javascript">
...
<script  type="text/javascript" src="https://cdn.jsdelivr.net/npm/js-cookie@3.0.5/dist/js.cookie.min.js"></script><script src="resources/jquery.treeview.js" type="text/javascript"></script>
...
<div id="main">
    <div class="header">
    	<div class="logo"><a href="#" onclick="doHomePageLink()"><img src="images/1904-06555 AICPA Online Professional Library-Graphic.png" alt="AICPA Online Professional Library" title="AICPA Online Professional Library" border="0" height="70"/></a></div>
...
<div id="footer">
	<div class="prefooter">
    	<ul class="tabs">
            <li class="homeIcon"><a href="#Toolbar-Home" onclick="doHomePageLink()"> Home |</a></li>
...
<script type='text/javascript'>
   ...
   // });
    ...
    $(function () {
        $('#content-container').css({ 'height': (($(document).height()) - 325) + 'px' });
        //$('#content-container').css({ 'height': (getContentAreaHeight() - 1085) + 'px' });
        //setContentSize();
        $(window).resize(function () {
            $('#content-container').css({ 'height': (($(document).height()) - 325) + 'px' });
          //  $('#content-container').css({ 'height': (getContentAreaHeight()- 1085) + 'px' });
