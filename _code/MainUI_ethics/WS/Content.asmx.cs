...
namespace MainUI.WS
{
    ...
    public class Content : AicpaService
    {
        ...
        [WebMethod(true)]
        public string GetNodeToGrandChildrenHtml(int id, string type)
        {
            int level = 0;
        ...
        private string convertToTreeViewHtml(BreadcrumbNode node, bool isALastChild, int level = 0, bool initial=false)
        {
            ...
            if ((node.Children != null) && (node.Children.Count > 0))
                childrenStr = "children expandable";
            ...
            } else if (type == "SiteFolder")
            {
                formatString = @"<li id=""currentLi-{3}"">" +
                               ...
                               @"<h2 class=""clearfix""><span class=""hitarea toggle""></span><img src=""images/icon_{0}.gif"">" +
