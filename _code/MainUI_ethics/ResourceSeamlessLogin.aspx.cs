    ...
    public partial class ProflitSeamlessLogin : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    logEvent = new Event(EventType.Error, DateTime.Now, 1, "ResourceSeamlessLogin.aspx", "Page_Load", "Empty Domain String", "Application received a domain string of '"+Domain+"'");
                    logEvent.Save(false);

                    throw new Exception("Error: Empty Domain string detected");
                }*/
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["prod"]))
                {
                    Url = "default.aspx";
                    productLogin = true;
                    referringSite = Request.QueryString["prod"];
                ...
                incomingParams = "hidEncPersGUID: " + Request.Params["hidEncPersGUID"];
                incomingParams = incomingParams + "hidSourceSiteCode: " + Request.Params["hidSourceSiteCode"];
                incomingParams = incomingParams + "hidURL: " + Request.Params["hidURL"];
                incomingParams = incomingParams + "hidDomain: " + Request.Params["hidDomain"];
                incomingParams = incomingParams + "hidEmail: " + Email;
                incomingParams = incomingParams + (referrer.Equals(string.Empty) ? string.Empty : string.Format("referrer: {0}", referrer));                
