...
namespace dk.nita.saml20.Validation
{
    internal class DKSaml20SubjectValidator : ISaml20SubjectValidator
    {
        ...
        #region ISaml20SubjectValidator Members

        public void ValidateSubject(Subject subject)
        {
            if (subject.Items == null || subject.Items.Length == 0)
                throw new DKSaml20FormatException(
                    "The DK-SAML 2.0 Profile requires at least one \"SubjectConfirmation\" element within the \"Subject\" element.");
            ...
            if (!subjectConfirmationPresent)
                throw new DKSaml20FormatException(
                    "The DK-SAML 2.0 Profile requires that a bearer \"SubjectConfirmation\" element is present.");
        }
