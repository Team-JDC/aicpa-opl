...
namespace dk.nita.saml20.Validation
{
    ...
    {
        #region ISaml20AttributeValidator Members
        ...
        public void ValidateAttribute(SamlAttribute samlAttribute)
        {
            if (!Uri.IsWellFormedUriString(samlAttribute.Name, UriKind.Absolute))
                throw new DKSaml20FormatException(
                    "The DK-SAML 2.0 profile requires that an attribute's \"Name\" is an URI.");
            ...
            foreach (object val in samlAttribute.AttributeValue)
            {
                ...
                throw new DKSaml20FormatException(
                    "The DK-SAML 2.0 profile requires that all attribute values are of type \"xs:string\".");
            }
        }
