    ...
    internal class DKSaml20AssertionValidator : Saml20AssertionValidator
    {
        ...
        private void ValidateSubject(Assertion assertion)
        {
            if (assertion.Subject == null)
                throw new DKSaml20FormatException(
                    "The DK-SAML 2.0 profile requires that a \"Subject\" element is present in the saml20Assertion.");
        ...
        private void ValidateStatements(Assertion assertion)
        {
            ...
            //    throw new DKSaml20FormatException("The SAML 2.0 profile does not contain an \"AuthnStatement\" and/or an \"AttributeStatement\" element.");
            ...
            //    throw new DKSaml20FormatException("The SAML 2.0 profile requires an \"AuthnStatement\" element and an \"AttributeStatement\" element.");            
        }
