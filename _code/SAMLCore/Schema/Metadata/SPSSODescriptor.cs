...
namespace dk.nita.saml20.Schema.Metadata
{
    ...
    public class SPSSODescriptor : SSODescriptor
    {
        ...
        {
            get { return assertionConsumerServiceField; }
            set { assertionConsumerServiceField = value; }
        }
        ...
        {
            get { return attributeConsumingServiceField; }
            set { attributeConsumingServiceField = value; }
        }
