...
namespace dk.nita.saml20.Schema.Metadata
{
    ...
    public class EntitiesDescriptor
    {
        ...
        {
            get { return validUntilField.ToUniversalTime().ToString("o"); }
            set { validUntilField = DateTime.Parse(value); }
        }
        ...
        {
            get { return validUntilFieldSpecified; }
            set { validUntilFieldSpecified = value; }
        }
