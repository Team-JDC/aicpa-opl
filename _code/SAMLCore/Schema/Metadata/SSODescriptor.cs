...
namespace dk.nita.saml20.Schema.Metadata
{
    ...
    public abstract class SSODescriptor : RoleDescriptor
    {
        ...
        {
            get { return artifactResolutionServiceField; }
            set { artifactResolutionServiceField = value; }
        }
        ...
        {
            get { return singleLogoutServiceField; }
            set { singleLogoutServiceField = value; }
        }
        ...
        {
            get { return manageNameIDServiceField; }
            set { manageNameIDServiceField = value; }
        }
