...
namespace dk.nita.saml20.config
{
    ...
    public class Certificate
    {
        ...
        /// Find value
        /// </summary>
        [XmlAttribute] public string findValue;

        /// <summary>
        /// Store location
        /// </summary>
        [XmlAttribute] public StoreLocation storeLocation;

        /// <summary>
        /// Store name
        /// </summary>
        [XmlAttribute] public StoreName storeName;

        /// <summary>
        /// Determines if only valid certificates are found
        /// </summary>
        [XmlAttribute] public bool validOnly;

        /// <summary>
        /// find type
        /// </summary>
        [XmlAttribute] public X509FindType x509FindType;
