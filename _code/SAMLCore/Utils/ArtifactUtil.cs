...
namespace dk.nita.saml20.Utils
{
    ...
    public class ArtifactUtil
    {
        ...
        public static string CreateArtifact(Int16 typeCodeValue, Int16 endpointIndexValue, byte[] sourceIdHash,
                                            byte[] messageHandle)
        {
        ...
        /// <param name="sourceIdHash"></param>
        /// <param name="messageHandle"></param>
        public static void ParseArtifact(string artifact, ref Int16 typeCodeValue, ref Int16 endpointIndex,
                                         ref byte[] sourceIdHash, ref byte[] messageHandle)
        {
            if (sourceIdHash.Length != SourceIdLength)
                throw new ArgumentException(
                    string.Format(argumentLengthErrorFmt, sourceIdHash.Length, SourceIdLength), "sourceIdHash");
        ...
        /// <param name="messageHandle"></param>
        /// <returns></returns>
        public static bool TryParseArtifact(string artifact, ref Int16 typeCodeValue, ref Int16 endpointIndex,
                                            ref byte[] sourceIdHash, ref byte[] messageHandle)
        {
            try
            {
        ...
        public static ushort GetEndpointIndex(string artifact)
        {
            ...
            if (TryParseArtifact(artifact, ref parsedTypeCode, ref parsedEndpointIndex, ref parsedSourceIdHash,
                                 ref parsedMessageHandle))
            {
