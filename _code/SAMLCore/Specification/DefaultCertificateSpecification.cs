...
namespace dk.nita.saml20.Specification
{
    ...
    {
        #region ICertificateSpecification Members
        ...
        public bool IsSatisfiedBy(X509Certificate2 certificate)
        {
            ...
            X509CertificateValidator defaultCertificateValidator =
                X509CertificateValidator.CreateChainTrustValidator(useMachineContext, chainPolicy);
            ...
            catch (Exception e)
            {
                Trace.TraceData(TraceEventType.Warning,
                                string.Format(Tracing.CertificateIsNotRFC3280Valid, certificate.SubjectName.Name,
                                              certificate.Thumbprint, e));
            }
