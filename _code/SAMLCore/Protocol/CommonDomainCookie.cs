...
namespace dk.nita.saml20.protocol
{
    ...
    public class CommonDomainCookie
    {
        ...
        private void EnsureSet()
        {
            ...
            if (!_isSet)
                throw new Saml20Exception(
                    "The common domain cookie is not set. Please make sure to check the IsSet property before accessing the class' properties.");
        }
        ...
        private void ParseCookie(string rawValue)
        {
            ...
            string[] idps = value.Split(new[] {' '}, StringSplitOptions.RemoveEmptyEntries);
