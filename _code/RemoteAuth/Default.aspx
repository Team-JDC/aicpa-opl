<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RemoteAuth.Default" %>
    ...
    <table>
        <tr>
            ...
            <td class="style2">
                ...
                <asp:TextBox ID="hidUserId" runat="server" Text="dwatson@knowlysis.com"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnLogin" runat="server" Text="Login" /><%--PostBackUrl="<%=strAction%>" />--%>
            </td>
        </tr>
    </table>    
    </div>
