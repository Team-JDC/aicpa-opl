    ...
    public class IDPSelectionUtil
    {
        ...
        public static string GetIDPLoginUrl(string idpId)
        {
            return string.Format("{0}?{1}={2}",
                                 ConfigurationInstance<SAML20FederationConfig>.GetConfig().ServiceProvider.
                                     SignOnEndpoint.localPath, Saml20AbstractEndpointHandler.IDPChoiceParameterName,
                                 HttpUtility.UrlEncode(idpId));
        }
    }
}