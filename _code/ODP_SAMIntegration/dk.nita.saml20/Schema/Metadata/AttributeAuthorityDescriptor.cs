...
using Attribute=dk.nita.saml20.config.Attribute;
...
namespace dk.nita.saml20.Schema.Metadata
{
    ...
    public class AttributeAuthorityDescriptor : RoleDescriptor
    {
        ...
        {
            get { return attributeServiceField; }
            set { attributeServiceField = value; }
        }
        ...
        {
            get { return nameIDFormatField; }
            set { nameIDFormatField = value; }
        }
