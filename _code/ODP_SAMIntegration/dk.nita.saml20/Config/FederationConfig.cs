...
namespace dk.nita.saml20.config
{
    ...
    [XmlRoot(ConfigurationConstants.SectionNames.Federation, Namespace = ConfigurationConstants.NamespaceUri,
        IsNullable = false)]
    public class FederationConfig : ConfigurationInstance<FederationConfig>
    {
        ...
        /// </summary>
        [XmlElement] public Certificate SigningCertificate;

        /// <summary>
        /// The list of trusted issuers - each represented by an X509 certificate reference
        /// </summary>
        [XmlArrayItem("TrustedIssuers", IsNullable = false)] public Certificate[] TrustedIssuers;
