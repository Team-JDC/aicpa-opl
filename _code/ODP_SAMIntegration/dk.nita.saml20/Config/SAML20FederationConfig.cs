...
namespace dk.nita.saml20.config
{
    ...
    [XmlRoot(ConfigurationConstants.SectionNames.SAML20Federation, Namespace = ConfigurationConstants.NamespaceUri,
        IsNullable = false)]
    public class SAML20FederationConfig : ConfigurationInstance<SAML20FederationConfig>
    {
        ...
        /// </summary>
        [XmlElement] public RequestedAttributes RequestedAttributes;

        /// <summary>
        /// Service provider
        /// </summary>
        [XmlElement] public ServiceProviderElement ServiceProvider;
    ...
    public class CommonDomainConfig
    {
        ...
        /// </summary>
        [XmlAttribute(AttributeName = "localReaderEndpoint")] public string LocalReaderEndpoint;
    }
    ...
    public class ConfigMetadata
    {
        ...
        /// </summary>
        [XmlAttribute("IncludeArtifactEndpoints", Namespace = ConfigurationConstants.NamespaceUri)] public bool
            IncludeArtifactEndpoints;
    }
    ...
    public class RequestedAttributes
    {
        ...
        /// Attributes
        /// </summary>
        [XmlElement("att")] public List<Attribute> Attributes;
    ...
    public class Attribute
    {
        ...
        /// </summary>
        [XmlAttribute("name", Namespace = ConfigurationConstants.NamespaceUri)] public string name;

        /// <summary>
        /// Is the attribute required
        /// </summary>
        [XmlAttribute("isRequired", Namespace = ConfigurationConstants.NamespaceUri)] public string required;
    ...
    public class IDPEndpoints
    {
        ...
        /// encoding specified.
        /// </summary>
        [XmlIgnore] private List<Encoding> _encodings;
        ...
        /// </summary>
        [XmlAttribute("encodings")] public string encodings;

        /// <summary>
        /// List of IdP endpoints
        /// </summary>
        [XmlElement("add")] public List<IDPEndPoint> IDPEndPoints;
        ...
        /// </summary>
        [XmlAttribute("idpSelectionUrl")] public string idpSelectionUrl;

        /// <summary>
        /// The directory in which the metadata files of trusted identity providers should be found.
        /// </summary>
        [XmlAttribute("metadata")] public string metadataLocation;
        ...
        /// </summary>
        [XmlIgnore] private readonly Dictionary<string, DateTime> _fileInfo;

        /// <summary>
        /// This dictionary links a file name to the entity id of the metadata document in the file.
        /// </summary>
        [XmlIgnore] private readonly Dictionary<string, string> _fileToEntity;
    ...
    public class ServiceProviderElement
    {
        ...
        /// Contact person
        /// </summary>
        [XmlElement(Namespace = Saml20Constants.METADATA)] public List<Contact> ContactPerson;
        ...
        /// Organization
        /// </summary>
        [XmlElement(Namespace = Saml20Constants.METADATA)] public Organization Organization;
        ...
        public string Server
        {
            get
            {
                ...
                if (_server == "http://" || _server == "https://")
                    return _server + Environment.MachineName.ToLower() + "." +
                           Environment.GetEnvironmentVariable("USERDNSDOMAIN").ToLower();
#endif
                return _server;
            }
            set { _server = value; }
        ...
        {
            get { return FindEndpoint(EndpointType.LOGOUT); }
        }
        ...
        {
            get { return FindEndpoint(EndpointType.SIGNON); }
        }
        ...
        {
            get { return FindEndpoint(EndpointType.METADATA); }
        }
    ...
    public class NameIdFormatsElement
    {
        ...
        /// </summary>
        [XmlAttribute(AttributeName = "all")] public bool All;

        /// <summary>
        /// List of supported NameFormatIds
        /// </summary>
        [XmlElement(ElementName = "add")] public List<NameIdFormatElement> NameIdFormats;
    ...
    public class NameIdFormatElement
    {
        ...
        /// The NameIdFormat
        /// </summary>
        [XmlAttribute(AttributeName = "nameIdFormat")] public string NameIdFormat;
    }
    ...
    public class Saml20ServiceEndpoint
    {
        ...
        /// Saml binding
        /// </summary>
        [XmlAttribute("binding")] public SAMLBinding Binding = SAMLBinding.NOT_SET;

        /// <summary>
        /// Numeric index of this endpoint
        /// </summary>
        [XmlAttribute("index")] public ushort endPointIndex;

        /// <summary>
        /// Type of endpoint
        /// </summary>
        [XmlAttribute("type")] public EndpointType endpointType;

        /// <summary>
        /// Error handling behaviour
        /// </summary>
        [XmlAttribute("errorBehaviour")] public ErrorBehaviour ErrorBehaviour = ErrorBehaviour.SHOWPAGE;

        /// <summary>
        /// The local path to the url on which this endpoint should be placed.
        /// </summary>
        [XmlAttribute("localpath")] public string localPath;

        /// <summary>
        /// Redirect to this url on succesful request
        /// </summary>
        [XmlAttribute("redirectUrl")] public string RedirectUrl;
    }
    ...
    public enum EndpointType
    {
        ...
        /// Signon endpoint
        /// </summary>
        [XmlEnum("signon")] SIGNON,
        /// <summary>
        /// Logout endpoint
        /// </summary>
        [XmlEnum("logout")] LOGOUT,
        /// <summary>
        /// Metadata endpoint
        /// </summary>
        [XmlEnum("metadata")] METADATA
    }
    ...
    public enum ErrorBehaviour
    {
        ...
        /// ShowPage behaviour
        /// </summary>
        [XmlEnum("showpage")] SHOWPAGE,
        /// <summary>
        /// ThrowException behaviour
        /// </summary>
        [XmlEnum("throwexception")] THROWEXCEPTION
    }
    ...
    public class IDPEndPoint
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "ArtifactResolution")] public HttpBasicAuthElement ArtifactResolution;

        /// <summary>
        /// AttributeQuery configuration parameters
        /// </summary>
        [XmlElement(ElementName = "AttributeQuery")] public HttpBasicAuthElement AttributeQuery;

        /// <summary>
        /// Common Domain Cookie settings
        /// </summary>
        [XmlElement(ElementName = "CDC")] public CDCElement CDC;

        /// <summary>
        /// Certificate validation
        /// </summary>
        [XmlElement(ElementName = "CertificateValidation")] public CertificateValidationElements CertificateValidation;

        /// <summary>
        /// Use default in case common domain cookie is not set, and more than one endpoint is available 
        /// </summary>
        [XmlAttribute(AttributeName = "default")] public bool Default;

        /// <summary>
        /// Force authentication on each authnrequest
        /// </summary>
        [XmlAttribute(AttributeName = "forceAuthn")] public bool ForceAuthn;
        ...
        /// </summary>
        [XmlAttribute(AttributeName = "isPassive")] public bool IsPassive;

        /// <summary>
        /// The metadata associated with the endpoint.
        /// </summary>
        [XmlIgnore] public Saml20MetadataDocument metadata;
        ...
        /// </summary>
        [XmlAttribute(AttributeName = "omitAssertionSignatureCheck")] public bool OmitAssertionSignatureCheck;

        /// <summary>
        /// Persistent pseudonym
        /// </summary>
        [XmlElement(ElementName = "PersistentPseudonym")] public PersistentPseudonymMapper PersistentPseudonym;

        /// <summary>
        /// Enable quirks mode
        /// </summary>
        [XmlAttribute(AttributeName = "QuirksMode")] public bool QuirksMode;

        /// <summary>
        /// Override option for the default UTF-8 encoding convention on SAML responses
        /// </summary>
        [XmlAttribute(AttributeName = "responseEncoding")] public string ResponseEncoding;

        /// <summary>
        /// Single log off
        /// </summary>
        [XmlElement(ElementName = "SLO")] public IDPEndPointElement SLOEndpoint;

        /// <summary>
        /// Single sign on
        /// </summary>
        [XmlElement(ElementName = "SSO")] public IDPEndPointElement SSOEndpoint;
    ...
    public class CertificateValidationElements
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "add")] public List<CertificateValidationElement> CertificateValidations;
    ...
    public class HttpBasicAuthElement
    {
        ...
        /// </summary>
        [XmlAttribute(AttributeName = "enableHttpBasicAuth")] public bool Enabled;

        /// <summary>
        /// The password
        /// </summary>
        [XmlAttribute(AttributeName = "password")] public string Password;

        /// <summary>
        /// The username
        /// </summary>
        [XmlAttribute(AttributeName = "username")] public string Username;
    }
    ...
    public class CDCElement
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "Settings")] public ExtraSettings ExtraSettings;
    }
    ...
    public class ExtraSettings
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "add")] public List<KeyValue> KeyValues;
    }
    ...
    public class KeyValue
    {
        ...
        /// The value
        /// </summary>
        [XmlAttribute(AttributeName = "value")] public string Value;
    }
    ...
    public class PersistentPseudonymMapper
    {
        ...
        /// Mapper to use
        /// </summary>
        [XmlAttribute("mapper")] public string Mapper;
    ...
    public class IDPEndPointElement
    {
        ...
        /// Binding
        /// </summary>
        [XmlAttribute(AttributeName = "binding")] public SAMLBinding Binding;

        /// <summary>
        /// Force a different protocol binding
        /// </summary>
        [XmlAttribute(AttributeName = "ForceProtocolBinding")] public string ForceProtocolBinding;

        /// <summary>
        /// Allows the caller to access the xml representation of an assertion before it's 
        /// translated to a strongly typed instance
        /// </summary>
        [XmlAttribute(AttributeName = "idpTokenAccessor")] public string IdpTokenAccessor;

        /// <summary>
        /// Url
        /// </summary>
        [XmlAttribute(AttributeName = "url")] public string Url;
