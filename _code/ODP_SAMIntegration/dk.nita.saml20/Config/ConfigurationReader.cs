...
namespace dk.nita.saml20.config
{
    ...
    public class ConfigurationReader : ConfigurationSection
    {
        ...
        {
            var serializer = new XmlSerializer(_currentConfigType);
        ...
        public static ConfigType GetConfig<ConfigType>() where ConfigType : class
        {
            ...
            lock (typeof (ConfigurationReader))
            {
                ...
                var result = ConfigurationManager.GetSection(sectionName) as ConfigType;
                return result;
            }
        }
        ...
        private static string GetConfigSectionName(Type t)
        {
            ...
            var rootAttribute = (XmlRootAttribute) attributes[0];
                                                   ...
                                                   ConfigurationSaveMode saveMode)
        {
            ...
            {
                var ser = new XmlSerializer(_currentConfig.GetType());
