namespace dk.nita.saml20
{
    ...
    public class Saml20Constants
    {
        ...
        /// </summary>
        public static readonly string[] SAML_NAMESPACES = new[] {ASSERTION, PROTOCOL, METADATA};

        #region Nested type: NameIdentifierFormats
        ...
        #region Nested type: ProtocolBindings
        ...
        #region Nested type: StatusCodes
        ...
        #region Nested type: SubjectConfirmationMethods
