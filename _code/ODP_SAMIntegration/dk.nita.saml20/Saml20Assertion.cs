...
namespace dk.nita.saml20
{
    ...
    public class Saml20Assertion
    {
        ...
        private ISaml20AssertionValidator AssertionValidator
        {
            get
            {
                if (_assertionValidator == null)
                {
                    ...
                    {
                        if (profile == AssertionProfile.DKSaml)
                            _assertionValidator = new DKSaml20AssertionValidator(config.AllowedAudienceUris.Audiences,
                                                                                 _quirksMode);
                        else
                            _assertionValidator = new Saml20AssertionValidator(config.AllowedAudienceUris.Audiences,
                                                                               _quirksMode);
                    }
                }
        ...
        {
            get { return Assertion.Subject.Items; }
        }
        ...
        {
            get { return _assertion.Conditions; }
        }
        ...
        /// <param name="quirksMode">if set to <c>true</c> quirks mode is enabled.</param>
        public Saml20Assertion(XmlElement assertion, IEnumerable<AsymmetricAlgorithm> trustedSigners,
                               AssertionProfile profile, bool quirksMode)
        {
        ...
        public Saml20Assertion(XmlElement assertion, IEnumerable<AsymmetricAlgorithm> trustedSigners,
                               AssertionProfile profile, bool quirksMode, bool autoValidate)
        {
            this.profile = profile;
            _quirksMode = quirksMode;
        ...
        public void Sign(X509Certificate2 cert)
        {
            ...
            LoadXml(assertionDocument.DocumentElement,
                    new List<AsymmetricAlgorithm>(new AsymmetricAlgorithm[] {cert.PublicKey.Key}));
        }
        ...
        private static void AddSignature(XmlDocument assertionDocument, X509Certificate2 cert)
        {
            ...
            XmlNodeList nodes = assertionDocument.DocumentElement.GetElementsByTagName("Issuer",
