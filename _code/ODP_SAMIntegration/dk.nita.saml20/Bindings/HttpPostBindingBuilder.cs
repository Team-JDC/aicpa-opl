...
namespace dk.nita.saml20.Bindings
{
    ...
    public class HttpPostBindingBuilder
    {
        ...
        /// </summary>
        private readonly IDPEndPointElement _destinationEndpoint;
            ...
            set
            {
                if (!string.IsNullOrEmpty(_response))
                    throw new ArgumentException(
                        "Response property is already specified. Unable to set Request property.");
                _request = value;
            }
        }
        ...
        public string Response
        {
            ...
            set
            {
                if (!string.IsNullOrEmpty(_request))
                    throw new ArgumentException(
                        "Request property is already specified. Unable to set Response property.");
        ...
        public Page GetPage()
        {
            if (_request == null && _response == null)
                throw new InvalidOperationException(
                    "A response or request message MUST be specified before generating the page.");
            ...
            p.Controls.Add(
                new LiteralControl(Environment.NewLine + "<body onload=\"document.forms[0].submit()\">" +
                                   Environment.NewLine));
            p.Controls.Add(
                new LiteralControl(
            ...
            p.Controls.Add(
                new LiteralControl("<noscript><div><input type=\"submit\" value=\"Continue\"/></div></noscript>"));
