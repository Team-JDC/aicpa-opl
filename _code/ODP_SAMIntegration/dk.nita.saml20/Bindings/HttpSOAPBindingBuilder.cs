...
namespace dk.nita.saml20.Bindings
{
    ...
    public class HttpSOAPBindingBuilder
    {
        ...
        public Stream GetResponse(string endpoint, string message, HttpBasicAuthElement basicAuth)
        {
            ...
            Message request = Message.CreateMessage(binding.MessageVersion, HttpArtifactBindingConstants.SOAPAction,
            ...
            var memStream = new MemoryStream(Encoding.ASCII.GetBytes(outerXml));
            return memStream;
        }
    }
