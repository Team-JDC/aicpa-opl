...
namespace dk.nita.saml20.identity
{
    ...
    public class Saml20Identity : GenericIdentity, ISaml20Identity
    {
        ...
        private readonly string _persistenPseudonym;
        ...
        #region ISaml20Identity Members
        ...
        {
            return Saml20PrincipalCache.GetPrincipal() != null &&
                   Saml20PrincipalCache.GetPrincipal().Identity is Saml20Identity;
        }
        ...
        internal static IPrincipal InitSaml20Identity(Saml20Assertion assertion, IDPEndPoint point)
        {
            ...
            var identity = new Saml20Identity(subjectIdentifier, assertion.Attributes,
                                              isPersistentPseudonym ? assertion.Subject.Value : null);
