...
namespace dk.nita.saml20.protocol
{
    ...
    public class Saml20MetadataHandler : AbstractEndpointHandler
    {
        ...
        {
            var configuration = ConfigurationReader.GetConfig<SAML20FederationConfig>();

            var keyinfo = new KeyInfo();
            var keyClause =
                new KeyInfoX509Data(
                    ConfigurationReader.GetConfig<FederationConfig>().SigningCertificate.GetCertificate(),
