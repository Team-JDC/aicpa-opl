...
function pressedKey(){
	...
	if(event.keyCode == 13){
		...
		if(oSearch.value != ""){
			showWaiting(false);
			/*oSearch.blur();
			if(document.getElementById("_ctl2_topSearchValue")){
				document.getElementById("_ctl2_topSearchValue").value = "DesktopDefault.aspx?tabindex=3&tabid=5&Search="+oSearch.value;
			}else if(document.getElementById("_ctl1_topSearchValue")){
				document.getElementById("_ctl1_topSearchValue").value = "DesktopDefault.aspx?tabindex=3&tabid=5&Search="+oSearch.value;
			}else{
				window.location.href = "DesktopDefault.aspx?tabindex=3&tabid=5&Search="+oSearch.value;			
			}	*/		
		}else{
			if(document.getElementById("_ctl1_SearchTextBox")){
				oSearch = document.getElementById("_ctl1_SearchTextBox");
				oSearch.blur();
				showWaiting(false);
				window.location.href = "DesktopDefault.aspx?tabindex=3&tabid=5&Search="+oSearch.value;
			}else{
