...
namespace AICPA.Destroyer.UI.Portal {
    ...
    public partial class DiscussDetails : System.Web.UI.Page {
        ...
        void BindData() {
            ...
            AICPA.Destroyer.UI.Portal.DiscussionDB discuss = new AICPA.Destroyer.UI.Portal.DiscussionDB();
        ...
        String ReTitle(String MessageTitle) {

            if (MessageTitle.Length > 0 & MessageTitle.IndexOf("Re: ",0) == -1) {
