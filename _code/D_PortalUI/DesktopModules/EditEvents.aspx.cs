...
namespace AICPA.Destroyer.UI.Portal {
    ...
    public partial class EditEvents : System.Web.UI.Page {
        ...
        //
        // It then uses the AICPA.Destroyer.UI.Portal.EventsDB() data component
        ...
        // create or update an event.  It uses the AICPA.Destroyer.UI.Portal.EventsDB()
        ...
        // an event.  It  uses the AICPA.Destroyer.UI.Portal.EventsDB() data component to
