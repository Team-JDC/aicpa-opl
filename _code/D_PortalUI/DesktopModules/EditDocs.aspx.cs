...
namespace AICPA.Destroyer.UI.Portal {
    ...
    public partial class EditDocs : System.Web.UI.Page {
        ...
        //
        // It then uses the AICPA.Destroyer.UI.Portal.DocumentDB() data component
        ...
        protected void Page_Load(object sender, System.EventArgs e) {
            ...
            if (Page.IsPostBack == false) {
                ...
                if (itemId != 0) {
                    ...
                    AICPA.Destroyer.UI.Portal.DocumentDB documents = new AICPA.Destroyer.UI.Portal.DocumentDB();
        ...
        // create or update an document.  It  uses the AICPA.Destroyer.UI.Portal.DocumentDB()
        ...
        // a document.  It  uses the AICPA.Destroyer.UI.Portal.DocumentsDB()
        // data component to encapsulate all data functionality.
        //
        //****************************************************************
