...
namespace AICPA.Destroyer.UI.Portal {
    ...
    public partial class EditAnnouncements : System.Web.UI.Page {
        ...
        //
        // It then uses the AICPA.Destroyer.UI.Portal.AnnouncementsDB() data component
        ...
        protected void Page_Load(object sender, System.EventArgs e) {
            ...
            if (Page.IsPostBack == false) {
                ...
                if (itemId != 0) {
                    ...
                    AICPA.Destroyer.UI.Portal.AnnouncementsDB announcementDB = new AICPA.Destroyer.UI.Portal.AnnouncementsDB();
        ...
        // create or update an announcement.  It  uses the AICPA.Destroyer.UI.Portal.AnnouncementsDB()
        ...
        // an announcement.  It  uses the AICPA.Destroyer.UI.Portal.AnnouncementsDB()
        // data component to encapsulate all data functionality.
        //
        //****************************************************************
