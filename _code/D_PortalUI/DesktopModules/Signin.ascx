<%@ Control language="c#" Inherits="AICPA.Destroyer.UI.Portal.Signin" CodeBehind="Signin.ascx.cs" AutoEventWireup="True" %>
<%--
...
--%>
<div id="adminArea" style="visibility:hidden;position:absolute;background-color:white">
