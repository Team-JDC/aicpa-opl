...
namespace AICPA.Destroyer.Shared
{
	...
	/// </summary>
	public class DestroyerUi : System.Web.UI.Page
	{
		public const string USER_SECURITYBYPASSDOMAIN_KEY = "User_SecurityBypassDomain";
		//public static string USER_SECURITYBYPASSDOMAIN = System.Configuration.ConfigurationSettings.AppSettings[USER_SECURITYBYPASSDOMAIN_KEY];
        //modified 1/20/10 djf
        public static string USER_SECURITYBYPASSDOMAIN = ConfigurationManager.AppSettings[USER_SECURITYBYPASSDOMAIN_KEY];
		...
		public const string ERROR_DOCUMENTNOTFOUND = "The requested document does not exist on this site (targetdoc: '{0}'; targetptr: '{1}').";
		public const string ERROR_RESOURCEBOOKACCESSDENIED = "You do not have access to the specified resource (resource book: '{0}', resource: '{1}'.)";
		public const string ERROR_RESOURCENAMEINVALID = "The specified resource name is invalid (resource book: '{0}', resource: '{1}'.)";
		public const string ERROR_RESOURCEFOLDERNOTFOUND = "A resource folder was not found for the specified resource book (resource book: '{0}', resource: '{1}'.)";
		public const string ERROR_RESOURCENOTFOUND = "The specified resource was not found (resource book: '{0}', resource: '{1}'.)";
		public const string ERROR_SEARCHINDEXOUTOFDATE = "Error instantiating the document. The site index may be out-of-date and should be rebuilt.";
        ...
        public const string REQPARAM_DISABLEFEATURES = "d_feat"; //features to disable
		...
		/// <returns></returns>
		public static IUser GetCurrentUser(System.Web.UI.Page page)
		{		
			//initialize to null
			IUser retUser = null;

			if(USER_SECURITYBYPASSDOMAIN == null || USER_SECURITYBYPASSDOMAIN == string.Empty)
			{
			...
			{
				retUser = new User.User(Guid.NewGuid(), ReferringSite.Csc);
				string domainList = USER_SECURITYBYPASSDOMAIN;
		...
		/// <returns></returns>
		public static ISite GetCurrentSite(System.Web.UI.Page page)
		{
			...
			if(CACHE_SITE_ON_SESSION)
			{
				...
				if(retSite == null)
				{
					...
					SiteStatus siteStatus = (SiteStatus)page.Session[SESSPARAM_CURRENTSITESTATUS];
...
//		}
		...
		/// <returns></returns>
		public static IDocument GetCurrentDocument(System.Web.UI.Page page)
		{
			...
			IDocument sessionDoc = (IDocument)page.Session[SESSPARAM_CURRENTDOCUMENT];
			...
			if(((docName == string.Empty || docName == null) || (bookName == string.Empty || bookName == null)) ||  (sessionDoc != null &&(sessionDoc.Book.Name == bookName && sessionDoc.Name == docName)))
			{
				doc = sessionDoc;
			}
			else //otherwise...
		...
		/// <returns></returns>
		public static IDocumentFormat GetCurrentDocumentFormat(System.Web.UI.Page page)
		{
			//initialize to null
			...
			if(currDocFormatId != EMPTY_STRING && currDocFormatId != null)
			{
				...
				Shared.ContentType contentType = (Shared.ContentType)int.Parse(currDocFormatId);
		...
		/// <param name="doc"></param>
		/// <returns></returns>
		public static IDocumentAnchor GetCurrentDocumentAnchor(System.Web.UI.Page page)
		{
		...
		public static DocTab GetDocumentTab(System.Web.UI.Page page)
		{
		...
		public static DocCmd GetDocumentCommand(System.Web.UI.Page page)
		{
		...
		/// <param name="page"></param>
		/// <returns></returns>
		public static string GetTocSyncPath(System.Web.UI.Page page)
		{
			//initialize to empty
			...
			else
			{
				...
				ArrayList strikeParams = new ArrayList();
		...
		public static void StrikeQueryStringParam(System.Web.UI.Page page, ArrayList strikeKeys)
		{
		...
		public static string GetTocSyncPathFromXml(string referenceXml, int nodeCount)
		{
            ...
            XmlDocument tocSyncPathXml = new XmlDocument();
		...
		public static string GetTocPath(IDocument doc)
		{
			...
			if(doc != null)
			{
				...
				XmlDocument docSiteRefXmlDoc = new XmlDocument();
		...
		public static string GetTocPath(IDocumentAnchor docAnchor)
		{
			...
			if(docAnchor != null)
			{
				...
				XmlDocument docAnchorSiteRefXmlDoc = new XmlDocument();
		...
		public static string GetTocPath(ISiteFolder siteFolder)
		{
			...
			if(siteFolder != null)
			{
				...
				XmlDocument siteFolderSiteRefXmlDoc = new XmlDocument();
		...
		public static void ShowHelp(System.Web.UI.Page page, HelpTopic helpTopic)
		{
		...
		public static void ShowTab(System.Web.UI.Page page, PortalTab portalTab, string reqExtra)
		{
			int tabId = (int)portalTab;
			int tabIndex = 0;
