...
namespace AICPA.Destroyer.UI.Portal {
    ...
    public class SiteConfiguration : DataSet {
        ...
        public class TabDataTable : DataTable, System.Collections.IEnumerable {
			...
			// dam tooltip
			private DataColumn columnToolTip;
			...
			//dam tooltip
			internal DataColumn ToolTipColumn 
			{
				get 
				{
            ...
            internal void InitVars() {
				...
				//dam tooltip
				this.columnToolTip = this.Columns["ToolTip"];
            ...
            private void InitClass() {
				...
				//dam tooltip
				this.columnToolTip = new DataColumn("ToolTip", typeof(string), null, System.Data.MappingType.Attribute);
				this.Columns.Add(this.columnToolTip);
