<%@ Page language="c#" Codebehind="PasswordReminder.aspx.cs" AutoEventWireup="True" Inherits="ExamCandidate.PasswordReminder" %>
				...
				<tr>
					...
					<td>
						<table width="100%" align="center">
							<tr>
								<td>
									<p style='FONT-SIZE:14pt;FONT-FAMILY:Arial;'><b>Your password is </b></p>
									<p style='FONT-SIZE:10pt;FONT-FAMILY:Arial;'><b><asp:Label Runat="server" ID="password"></asp:Label></b></p>
									<p style='FONT-SIZE:10pt;FONT-FAMILY:Arial;'>Click <b><a href="login.htm">here</a></b> to return to the login screen to enter your Username and Password</p>
								</td>
							</tr>
						</table>
					</td>
