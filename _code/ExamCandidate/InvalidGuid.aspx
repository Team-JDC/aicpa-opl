<%@ Page language="c#" Codebehind="InvalidGuid.aspx.cs" AutoEventWireup="True" Inherits="ExamCandidate.InvalidGuid" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>InvalidGuid</title>
				...
				<tr>
					<td>
						<table width="%100" align="center">
							<tr>
								<td>
                                    <h4>Welcome to AICPA Online Library</h4>
                                  </td>
							</tr>
							<!-- <tr>
								<td>
				...
				<tr>
					...
					<td>
						<table width="100%" align="center">
							<tr>
								<td>
									<p style='FONT-SIZE:14pt;FONT-FAMILY:Arial;'><b>Registration Identifier Is Invalid</b></p>
									<p style='FONT-SIZE:10pt;FONT-FAMILY:Arial;'>The registration identifier you are using is not valid.</p>
									<p style='FONT-SIZE:10pt;FONT-FAMILY:Arial;'>Click <b><asp:hyperlink id="redirect" Runat="server">here</asp:hyperlink></b> to get a new registration code</p>
								</td>
							</tr>
						</table>
					</td>
