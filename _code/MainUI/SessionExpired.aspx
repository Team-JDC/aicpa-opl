<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionExpired.aspx.cs" Inherits="MainUI.SessionExpired" %>
                        ...
                        <div class="leftcol_inner">
                            ...
                            <div class="leftcol_content clearfix">
                                <div class="col-sm-12 pad20">
                                    <h2>Your session has expired. To establish a new session close this window and 
				return to your login page. </h2>
